...
#define leds *((unsigned *) SORTIE_BASE)

#define prescaler *((unsigned *)PWM_0_BASE)
#define freq *((unsigned *)(PWM_0_BASE + 4))
#define duty *((unsigned *)(PWM_0_BASE +8))
#define start *((unsigned *)(PWM_0_BASE +12))

#define animo_conf (unsigned int *) ANIMO_0_BASE
...
#define boutonp_conf (unsigned int *) BOUTONP_0_BASE
